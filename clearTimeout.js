...
//Javascript also has a another method called clearTimeout which actually cancels the timer if the test
//condition specified is true.

if (ingredeints.includes("spinach")) clearTimeout(pizzaLover);
